...
async def list_events(
    ...
    *,
    ...
    """Filtered, cursor-paginated query. REQUIREMENTS.md 4a-4c: filters combine
    with AND; resourceType/resourceId are independently valid filters. 5a/5d/5b:
    keyset pagination on sequence_number, descending (newest first). 4a: from/to
    filter the caller-supplied timestamp, not recorded_at. Scenario B 1e: archived
